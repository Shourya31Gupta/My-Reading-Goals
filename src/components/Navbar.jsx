...
export const Navbar = () => {
  ...
  const linkClasses = (path) =>
    `flex items-center gap-2 text-sm sm:text-base font-medium px-3 sm:px-5 py-2 sm:py-3 rounded-xl transition-all duration-300 ${
          ...
          <div className="ml-4 flex items-center gap-3">
            {!loading && !user && (
              <button
                ...
                className="flex items-center gap-2 text-sm sm:text-base font-medium px-3 sm:px-5 py-2 sm:py-3 rounded-xl transition-all duration-300 text-slate-700 hover:text-blue-600 hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 hover:shadow-md border border-transparent hover:border-blue-200"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {!loading && user && (
              <>
                ...
                <button
                  ...
                  className="flex items-center gap-2 text-sm sm:text-base font-medium px-3 sm:px-4 py-2 rounded-xl transition-all duration-300 text-slate-700 border border-slate-200 hover:bg-gradient-to-r hover:from-slate-50 hover:to-slate-100 hover:border-slate-400"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
